...
export class ontime1639830737731 implements MigrationInterface {
    name = 'ontime1639830737731'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`sebackend\`.\`Task\` (\`pkTask_Id\` int NOT NULL AUTO_INCREMENT, \`Title\` varchar(32) NULL, \`Content\` varchar(32) NULL, \`TaskRole\` enum ('Task', 'Important', 'Flag', 'Plan') NOT NULL, \`Start\` datetime NOT NULL, \`Due\` datetime NOT NULL, \`Color\` varchar(255) NOT NULL DEFAULT '#71B5E3', \`OnTime\` tinyint NOT NULL DEFAULT 0, \`TaskType\` enum ('Personal', 'Team') NOT NULL, \`userPkAccountId\` int NULL, \`teamPkTeamId\` varchar(255) NULL, INDEX \`IDX_3554333edd8fc7da5d0efdca51\` (\`TaskType\`), PRIMARY KEY (\`pkTask_Id\`)) ENGINE=InnoDB`);
